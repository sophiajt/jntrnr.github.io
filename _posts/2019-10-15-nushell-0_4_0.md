...
![The prompt with the latest colors](https://jonathanturner.org/images/0_4_0_new_colors.png)
New colors!
...
![Animation of a long table streaming out](https://jonathanturner.org/images/0_4_0_streaming_table.gif)
Streaming tables
...
For those of you wondering if and when Nu was going to be usable on stable Rust, you need but wait just a little longer. Contributer est31 has been hard at work at moving Nu only stable Rust and has now successfully moved Nu off of nightly and onto beta. As beta matures and becomes the next release of Rust, we'll be able to move Nu onto stable. This should help people who are working to distribute Nu on various distributions.

## Brazilian Portuguese book (marcelocg)

Contributor marcelocg surprised us with a translation of the Nu book into Brazillian Portugueuse. Obrigado, Marcelo!
