...
![Table with utf8 box drawing](https://jntrnr.com/images/utf8_table.png)

One of the most striking differences is that Nu now uses UTF-8 box drawing to draw its tables. 

![Table with utf8 box drawing in light mode](https://jntrnr.com/images/utf8_light_table.png)
...
![Improve error messages](https://jntrnr.com/images/did_you_mean.png)
